package com.example.regreen.component;
...
public class CodiaRoundLayoutUtil {
    ...
    private CanvasRounder canvasRound;
    ...
    public void init(CornersHolder holder) {
        canvasRound = CanvasRounder.create(holder);
        view.setOutlineProvider(RoundOutlineProvider.from(holder));
        view.setClipToOutline(true);
    }

    public void init(int radius) {
        CornersHolder holder = CornersHolder.create(radius);
        init(holder);
    }
    ...
    public void updateRectRadius(float radius) {
        ...
        view.setOutlineProvider(RoundOutlineProvider.from(radius));
        view.invalidate();
    }
    ...
    public void updateRectRadius(float topLeft, float topRight, float bottomRight, float bottomLeft) {
        ...
        view.setOutlineProvider(RoundOutlineProvider.from(topLeft, topRight, bottomRight, bottomLeft));
        view.invalidate();
    }
